...
class Dataset(data.Dataset): 
    ...
    def __init__(self, opt):
        ...
        #self.patch_size = 64
        self.image_size = (opt['H_size'], opt['H_size'])
    ...
    def __getitem__(self, index):
        ...
        img_A = util.imread_uint(A_path, self.n_channels,self.image_size)
        img_B = util.imread_uint(B_path, self.n_channels,self.image_size)
